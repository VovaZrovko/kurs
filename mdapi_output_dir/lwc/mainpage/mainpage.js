...
export default class Mainpage extends LightningElement {
    ...
    async checkQuery(){
        ...
        //console.log('PR ' + this.procResult); its working with await
    ...
    sumUp(pr,pw,mr,hd,sd,rm,vd,snd,crp){
        let price = pr.Price__c + pw.Price__c + mr.Price__c + hd.Price__c + sd.Price__c + rm.Price__c + vd.Price__c + snd.Price__c + crp.Price__c;
        return price;
    }
}                                               